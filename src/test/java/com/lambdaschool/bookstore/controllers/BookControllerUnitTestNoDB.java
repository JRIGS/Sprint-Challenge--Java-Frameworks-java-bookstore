...
public class BookControllerUnitTestNoDB
{
    ...
    public void getBookById() throws
            Exception
    {
        String apiUrl = "/books/book/4";
        Mockito.when(bookService.findBookById(4))
            .thenReturn(bookService.findBookById(4));
        ...
        ObjectMapper mapper = new ObjectMapper();
        String er = mapper.writeValueAsString(bookService.findBookById(4));
...
//        ObjectMapper mapper = new ObjectMapper();
            ...
            Exception
    {
        ...
        Author a1 = new Author("Jonathan", "Raczkowski");
        a1.setAuthorid(1);

        Section s2 = new Section("Technology");
        s2.setSectionid(12);

        Book b1 = new Book("Flattenedland", "97820738106752", 2001, s2);
        b1.setSection(s2);
        b1.setBookid(21);
